...
reason
# OBS: edit_context_validation=present
# OBS: finish_validation=present
# OBS: failed_stage_cleanup=present
# OBS: publication_guards=complete
# EXIT: 0
# OBS: malformed_candidate=rejected
# OBS: rejected_stage_cleanup=complete
# EXIT: 0
# EXIT: 0
finish
