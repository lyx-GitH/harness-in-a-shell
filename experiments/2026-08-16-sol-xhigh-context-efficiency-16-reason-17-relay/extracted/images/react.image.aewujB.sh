...
reason
# OBS: bytes=8701 prompt_view_bytes=5962 system_bytes=2762 saved_per_call=2739
# OBS: reason_calls=4 limit=16 canonical_present=no
# EXIT: 0
# REASON-CALL: 5/16
# Validation passed: syntax, marker integrity, prompt deduplication, call limits,
# sibling execution, and atomic finalization checks succeeded.
finalize
